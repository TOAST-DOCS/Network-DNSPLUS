...
- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {zoneId}는 DNS Zone ID이며 [DNS Zone 조회](./api-guide/#query-dns-zone)를 통해서 알 수 있습니다.
...
- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- DNS Zone ID는 [DNS Zone 조회](./api-guide/#query-dns-zone)를 통해서 알 수 있습니다.
...
- {zoneId}는 DNS Zone ID이며 [DNS Zone 조회](./api-guide/#query-dns-zone)를 통해서 알 수 있습니다.
- 레코드값은 필수이며 입력 방법으로 recordset.recordList[0].recordContent 필드 또는 상세 필드를 선택할 수 있습니다.
- recordContent 필드는 공백을 구분 문자로 하여 상세 필드를 한 줄로 표시한 내용입니다. 상세 필드는 [레코드 세트 생성](./api-guide/#create-record-set)에 [레코드 세트 타입에 따른 상세 필드]에서 확인할 수 있습니다.
- 상세 필드와 recordContent 필드를 동시에 입력하면 recordContent 필드를 기준으로 생성됩니다.
...
- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {zoneId}는 DNS Zone ID이며 [DNS Zone 조회](./api-guide/#query-dns-zone)를 통해서 알 수 있습니다.
- {recordsetId}는 레코드 세트 ID이며 [레코드 세트 조회](./api-guide/#query-record-set)를 통해서 알 수 있습니다.
- 레코드값은 필수이며 입력 방법으로 recordset.recordList[0].recordContent 필드 또는 상세 필드를 선택할 수 있습니다.
- recordContent 필드는 공백을 구분 문자로 하여 상세 필드를 한 줄로 표시한 내용입니다. 상세 필드는 [레코드 세트 생성](./api-guide/#create-record-set)에 [레코드 세트 타입에 따른 상세 필드]에서 확인할 수 있습니다.
...
- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {zoneId}는 DNS Zone ID이며 [DNS Zone 조회](./api-guide/#query-dns-zone)를 통해서 알 수 있습니다.
- 레코드 세트 ID는 [레코드 세트 조회](./api-guide/#query-record-set)를 통해서 알 수 있습니다.
...
- [GSLB 생성](./api-guide/#create-gslb)에서 입력한 항목을 수정합니다.
...
- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {gslbId}는 GSLB ID이며 [GSLB 조회](./api-guide/#query-gslb)를 통해서 알 수 있습니다.
- connectedPoolRegionContent 필드는 쉼표(,)를 구분 문자로 하여 **지역**을 한 줄로 작성합니다.
...
- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {gslbId}는 GSLB ID이며 [GSLB 조회](./api-guide/#query-gslb)를 통해서 알 수 있습니다.
- {poolId}는 Pool ID이며 [Pool 조회](./api-guide/#query-pool)를 통해서 알 수 있습니다.
- connectedPoolRegionContent 필드는 쉼표(,)를 구분 문자로 하여 **지역**을 한 줄로 작성합니다.
...
- [GSLB 생성](./api-guide/#create-gslb)의 Pool 설정 또는 [Pool 연결](./api-guide/#connect-pool)에서 입력한 항목을 수정합니다.
...
- [Pool 생성](./api-guide/#create-pool)에서 입력한 항목을 수정합니다.
...
- 헬스 체크를 수정합니다.
- [헬스 체크 생성](./api-guide/#create-health-check)에서 입력한 항목을 수정합니다.
...
- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {healthCheckId}는 헬스 체크 ID이며 [헬스 체크 조회](./api-guide/#query-health-check)를 통해서 알 수 있습니다.
