...
| 메서드 | URI |
|---|---|
| GET | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones |
...
```
curl -X GET 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones'
```
...
| 메서드 | URI |
|---|---|
| POST | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones |
...
```
curl -X POST 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones' \
...
| 메서드 | URI |
|---|---|
| PUT | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId} |

[요청 본문]

- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {zoneId}는 DNS Zone ID이며 [DNS Zone 조회](./api-guide-gov/#dns-zone)에서 확인할 수 있습니다.
...
| 메서드 | URI |
|---|---|
| DELETE | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/async |

[요청 본문]

- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- DNS Zone ID는 [DNS Zone 조회](./api-guide-gov/#dns-zone)에서 확인할 수 있습니다.
...
| 메서드 | URI |
|---|---|
| GET | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets |
...
- 레코드 세트 생성 개수는 제한되어 있으며 연장이 필요한 경우 별도로 문의하세요. [1:1 문의](https://www.gov-nhncloud.com/kr/support/inquiry)
...
| 메서드 | URI |
|---|---|
| POST | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets |
...
```
curl -X POST 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| POST | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets/list |
...
```
curl -X POST 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets/list' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| PUT | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets/{recordsetId} |

[요청 본문]

- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {zoneId}는 DNS Zone ID이며 [DNS Zone 조회](./api-guide-gov/#dns-zone)에서 확인할 수 있습니다.
- {recordsetId}는 레코드 세트 ID이며 [레코드 세트 조회](./api-guide-gov/#_11)에서 확인할 수 있습니다.
- 레코드값은 필수이며 입력 방법으로 recordset.recordList[0].recordContent 필드 또는 상세 필드를 선택할 수 있습니다.
- recordContent 필드는 공백을 구분 문자로 하여 상세 필드를 한 줄로 표시한 내용입니다. 상세 필드는 [레코드 세트 생성](./api-guide-gov/#_14)에 [레코드 세트 타입에 따른 상세 필드]에서 확인할 수 있습니다.
- 상세 필드와 recordContent 필드를 동시에 입력하면 recordContent 필드를 기준으로 수정됩니다.

```
curl -X PUT 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets/{recordsetId}' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| DELETE | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/zones/{zoneId}/recordsets |

[요청 본문]

- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {zoneId}는 DNS Zone ID이며 [DNS Zone 조회](./api-guide-gov/#dns-zone)에서 확인할 수 있습니다.
- 레코드 세트 ID는 [레코드 세트 조회](./api-guide-gov/#_11)에서 확인할 수 있습니다.
...
| 메서드 | URI |
|---|---|
| GET | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs |
...
```
curl -X GET 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs?showHealthy=true'
```
...
- GSLB 생성 개수와 Pool 연결 개수는 제한되어 있으며 연장이 필요한 경우 별도로 문의하세요. [1:1 문의](https://www.gov-nhncloud.com/kr/support/inquiry)
...
| 메서드 | URI |
|---|---|
| POST | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs |
...
```
curl -X POST 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| PUT | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs/{gslbId} |

[요청 본문]

- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {gslbId}는 GSLB ID이며 [GSLB 조회](./api-guide-gov/#gslb)에서 확인할 수 있습니다.
- connectedPoolRegionContent 필드는 쉼표(,)를 구분 문자로 하여 **지역**을 한 줄로 작성합니다.

```
curl -X PUT 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs/{gslbId}' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| DELETE | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs |
...
```
curl -X DELETE 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs?
...
- Pool 연결 개수는 제한되어 있으며 연장이 필요한 경우 별도로 문의하세요. [1:1 문의](https://www.gov-nhncloud.com/kr/support/inquiry)
...
| 메서드 | URI |
|---|---|
| POST | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs/{gslbId}/connected-pools/{poolId} |

[요청 본문]

- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {gslbId}는 GSLB ID이며 [GSLB 조회](./api-guide-gov/#gslb)에서 확인할 수 있습니다.
- {poolId}는 Pool ID이며 [Pool 조회](./api-guide-gov/#pool_3)에서 확인할 수 있습니다.
- connectedPoolRegionContent 필드는 쉼표(,)를 구분 문자로 하여 **지역**을 한 줄로 작성합니다.

```
curl -X POST 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs/{gslbId}/connected-pools/{poolId}' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| PUT | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs/{gslbId}/connected-pools/{poolId} |
...
```
curl -X PUT 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs/{gslbId}/connected-pools/{poolId}' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| DELETE | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/gslbs/{gslbId}/connected-pools |
...
| 메서드 | URI |
|---|---|
| GET | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/pools |
...
```
curl -X GET 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/pools?showHealthy=true'
```
...
- Pool의 생성 개수, Pool 내의 엔드포인트 개수, 전체 엔드포인트의 개수는 제한되어 있으며 연장이 필요한 경우 별도로 문의하세요. [1:1 문의](https://www.gov-nhncloud.com/kr/support/inquiry)
...
| 메서드 | URI |
|---|---|
| POST | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/pools |
...
```
curl -X POST 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/pools' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| PUT | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/pools/{poolId} |
...
| 메서드 | URI |
|---|---|
| DELETE | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/pools |
...
```
curl -X DELETE 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/pools?
...
| 메서드 | URI |
|---|---|
| GET | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/health-checks |
...
```
curl -X GET 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/health-checks'
```
...
- 헬스 체크 생성 개수는 제한되어 있으며 연장이 필요한 경우 별도로 문의하세요. [1:1 문의](https://www.gov-nhncloud.com/kr/support/inquiry)
...
| 메서드 | URI |
|---|---|
| POST | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/health-checks |
...
```
curl -X POST 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/health-checks' \
-H 'Content-Type: application/json' \
...
| 메서드 | URI |
|---|---|
| PUT | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/health-checks/{healthCheckId} |

[요청 본문]

- {appkey}는 콘솔에서 확인한 값으로 변경합니다.
- {healthCheckId}는 헬스 체크 ID이며 [헬스 체크 조회](./api-guide-gov/#_45)에서 확인할 수 있습니다.
...
| 메서드 | URI |
|---|---|
| DELETE | https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/health-checks |
...
```
curl -X DELETE 'https://dnsplus.api.gov-nhncloudservice.com/dnsplus/v2.0/appkeys/{appkey}/health-checks?
